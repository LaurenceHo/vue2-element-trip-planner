...
router.get('/:trip_id/day',
  ...
  tripDayController.retrieve);

router.get('/:trip_id/day/:trip_day_id',
  authenticationService.checkTripOwner,
  authenticationService.checkTripDayOwner,
  tripDayController.retrieveDetail);

router.post('/:trip_id/day/create',
  authenticationService.checkTripOwner,
  tripDayController.create);

router.put('/:trip_id/day/update',
  authenticationService.checkTripOwner,
  tripDayController.update);

router.delete('/:trip_id/day/:trip_day_id',
  authenticationService.checkTripOwner,
  authenticationService.checkTripDayOwner,
