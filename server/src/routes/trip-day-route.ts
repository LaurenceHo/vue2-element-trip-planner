...
router.get('/:trip_id/day/:trip_day_id', authenticationService.checkTripOwner, tripDayController.retrieveDetail);
...
router.delete('/:trip_id/day/:trip_day_id', authenticationService.checkTripOwner, tripDayController.delete);
